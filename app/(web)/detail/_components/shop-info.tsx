        ...
        <>
          <Card className="w-full bg-white rounded-lg shadow-custom">
            <CardContent className="!p-4">
              <h2 className="font-semibold text-xs text-[#dc2626] uppercase mb-2">
                Price
              </h2>
              <div>
            ...
            <CardContent className="!p-4">
              ...
              >
                <Avatar className="w-12 h-12">
                  <AvatarFallback className="bg-[#dc2626] w-full flex items-center justify-center">
          ...
          >
            <CardContent className="!p-4">
              <h2 className="font-bold text-lg text-center mb-2 text-[#dc2626]">
                Safety tips
              </h2>
              <ul
                role="list"
