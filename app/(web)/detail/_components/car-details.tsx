...
import { CheckSquare, CogIcon, FuelIcon, GaugeIcon, TagIcon } from "lucide-react";
      ...
      {isPending ? (
        ...
        <Card className="!rounded-t-none rounded-b-[8px] shadow-none">
          ...
          <li
                ...
                >
                  <span className="border-2 rounded-full p-3">
                    <CogIcon className="size-5 text-[#dc2626]" />
                  </span>
                  {transmissionLabel}
                </li>
                <li
                ...
                >
                  <span className="border-2 rounded-full p-3">
                    <TagIcon className="size-5 text-[#dc2626]" />
                  </span>
                  {conditionLabel}
                </li>
              </ul>
            ...
            <div className="my-4">
                <ul className="grid grid-cols-2 gap-5">
                    <li>
                        <h5 className="uppercase  text-xs mb-[1px] text-[#dc2626]">Brand</h5>
                ...
                >
                  {keyFeatures?.map((feature, index) => (
                    <li
                      ...
                      "
                    >
                      <CheckSquare className="w-4 h-4 text-[#dc2626]/80" />
                      {feature.label}
                    </li>
                  ))}
                </ul>
